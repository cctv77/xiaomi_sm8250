...
# ------------- Building for AOSP -------------
    ...
    export KBUILD_BUILD_VERSION="1" LOCALVERSION="-g92c089fc2d37" KBUILD_BUILD_USER="xiaomi" KBUILD_BUILD_HOST="root" KBUILD_BUILD_TIMESTAMP="Wed Jun 5 13:27:08 UTC 2024"
